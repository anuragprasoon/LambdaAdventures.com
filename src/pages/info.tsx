...
export default function Info() {
  ...
  <ul className="w-full text-base  font-normal leading-[30px] list-decimal pl-5 max-md:max-w-full">
    ...
    <li>
      Neither Lambda Adventures nor any third parties provide any warranty or guarantee as to the accuracy, timeliness, performance, completeness, or suitability of the information and materials found or offered on this Website for any particular purpose. Information and materials may contain inaccuracies or errors, and Lambda Adventures expressly excludes liability for any such inaccuracies or errors to the fullest extent permitted by law.
    </li>
    <li>
      Your use of any information or materials on this Website is entirely at your own risk. It is your responsibility to ensure that any products, services, or information available meet your specific requirements. Lambda Adventures shall not be liable for any loss or damage, direct or indirect, arising from your use of the Website or its content.
    </li>
    <li>
      This Website contains material owned by or licensed to Lambda Adventures, including but not limited to the design, layout, look, appearance, and graphics. Reproduction is prohibited except as permitted by the copyright notice, which forms part of these terms and conditions.
    </li>
    <li>
      All trademarks reproduced in this Website which are not the property of, or licensed to, Lambda Adventures are acknowledged on the Website.
    </li>
    <li>
      Unauthorized use of this Website may give rise to a claim for damages and/or be a criminal offence.
    </li>
    <li>
      This Website may include links to other websites for your convenience. These links do not signify that Lambda Adventures endorses the website(s). Lambda Adventures has no responsibility for the content of the linked website(s).
    </li>
    <li>
      You may not create a link to this Website from another website or document without Lambda Adventures’ prior written consent.
    </li>
    <li>
  ...
  <p className="w-full text-base  font-normal leading-[30px] max-md:max-w-full mt-4">
    ...
    <li>
      <span className="font-semibold">Cancellation between 29 and 21 days before the trek start date:</span> Refund will be processed after deducting 50% as cancellation charges.
    </li>
    <li>
      <span className="font-semibold">Cancellation within 20 days prior to the trek start date or no show:</span> No refund or voucher will be issued.
    </li>
    <li>
      <span className="font-semibold">If you registered using a voucher:</span> The above cancellation policy applies. Any remaining balance after cancellation charges will stay credited to your account. If the voucher has expired at the time of cancellation, no refund, voucher, or extension will be provided.
    </li>
  </ul>
      </p>
    </section>
    ...
    <br /><br />
    By using our website, you consent to this policy. We may update this Privacy Policy from time to time; changes will be posted here. For any questions or concerns about your data or this policy, please contact us at info@Lambda Adventures.com.
      </p>
    </section>
