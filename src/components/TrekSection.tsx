...
const TrekSection: React.FC<TrekSectionProps> = ({
  ...
  return <div className="w-full max-md:max-w-full px-4 sm:px-6 lg:px-10 md:px-0">
      <div className="flex w-full gap-[40px_100px] justify-between flex-wrap max-md:max-w-full">
        <h2 className="text-[rgba(1,124,109,1)] text-[32px] font-bold leading-none">
          {title}
        </h2>
        <div className="text-[rgba(34,34,34,1)] text-xl font-semibold leading-none cursor-pointer hover:text-[rgba(1,124,109,1)]">
         <Link href={'/trek'}>View all</Link> 
        </div>
      </div>
      <div className="flex w-full gap-[34px] justify-between mt-[41px] max-md:max-w-full max-md:mt-10 pb-4">
