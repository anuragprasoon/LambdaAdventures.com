...
const PopUp:React.FC=()=>{
    ...
    return(popview?<>
        ...
        <a href={"/trek/79"}><img className="rounded w-full" src="https://res.cloudinary.com/anuragprasoon/image/upload/v1751835393/sacred-pause-com/ad-story_lambda-2.png"/></a>
        </div>
